...
`describe()` is used to group similar tests together into a suite, whereas `it()` represents an individual test.

2. What is the point of `Test Driven Development`? What do you think about this approach?

It allows us to avoid bugs and surprises during development by ensuring our code is behaving as it should, rather than trying to make the code work as we develop it.
